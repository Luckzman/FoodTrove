...
const ProductCard = ({ cardType }: TProductCard) => {

  return (
    <div
      className={`grid ${cardType === "portrait" ? "grid-row-2" : "lg:grid-cols-4"} gap-10 p-[13px] border-solid border-[1px] border-[#E9E9E9] rounded-lg`}
    >
      ...
      >
        ...
        <div className="w-[100px]  mt-[10px] flex items-center justify-between">
          <div className="flex">
            <TiStarOutline />
            <TiStarOutline />
            <TiStarOutline />
          </div>
          <p className="text-[#B6B6B6] text-[14px]">(4.0)</p>
        </div>
        ...
        <div className="flex items-center justify-between mt-[18px]">
          ...
          <button className="flex items-center justify-around bg-[#F53E32] text-white text-[14px] px-5 py-2 rounded-md">
